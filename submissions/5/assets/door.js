    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            if(!hitDone){
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=6113&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + pvid + '&c=' + hasConsent;
                var im=new Image;
                im.src = imgUrl;
                        ...
                        window.DotMetricsSettings =
                                    {
                                        ...
                                        ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=88efa144-2c08-4b86-9372-6e42e68ffd67',
                                        ...
                                        AdexEnabled: false,
                                        AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=184&id=6113',
